# Contributing to stacktrace-start

:sparkles: Thanks for your contribution in advance! :tada:

First and foremost, thank you! We appreciate that you want to contribute to `stacktrace-start`, your time is valuable, and your contributions mean a lot to us.
...
As a user of `stacktrace-start` you're the perfect candidate to help us improve our documentation. Typo corrections, error fixes, better explanations, more examples, etc. Open issues for things that could be improved. Anything. Even improvements to this document.

Use the [`docs` label](https://github.com/tunnckoCore/stacktrace-start/labels/docs) to find suggestions for what we'd love to see more documentation on.
...
We're always looking for more opinions on discussions in the issue tracker. It's a good opportunity to influence the future direction of `stacktrace-start`.

The [`question` label](https://github.com/tunnckoCore/stacktrace-start/labels/question%20%2F%20discussion) is a good place to find ongoing discussions.
...
1. **version**: what version of `stacktrace-start` were you using when you experienced the bug?
